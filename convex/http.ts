  ...
  switch (event.type) {
    case "user.created":
      await ctx.runMutation(internal.users.createUser, {
        ...
        isActive: true, // or false, depending on your requirements
        isAdmin: false, // or true, depending on your requirements
      });
      break;
    case "user.updated":
    ...
    case "user.deleted":
      ...
      break;
    // Adicionar casos para outros eventos, se necessário, seguindo o mesmo padrão
  }
